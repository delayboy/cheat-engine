...
typedef VOID(__stdcall* CEP_CONTROL_SETCAPTION)(PVOID control, const char* caption);
...
typedef BOOL(__stdcall* CEP_DBKResumeProcess)(DWORD ProcessID);
/*
...
typedef struct _ExportedFunctions
{
	...
	CEP_DBKResumeProcess DBKResumeProcess;			//   ...
	PVOID KernelAlloc;				//   ...
