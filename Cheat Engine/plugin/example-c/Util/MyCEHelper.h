...
extern const char* messageBoxScript;
...
typedef struct
{
    ...
    __int64 bytesize;
    bool isfloat;
    __int64 savedsize;//stack savedsize
    char* stack;
...
C_ASSERT(GET_MEMBER_OFFSET(TTreeNode, Count) == 0x24);
C_ASSERT(GET_MEMBER_OFFSET(TTreeNode, Data) == 0X28);
C_ASSERT(GET_MEMBER_OFFSET(TTreeNode, Items) == 0x40);
C_ASSERT(GET_MEMBER_OFFSET(TTreeNode, parent) == 0x60);
C_ASSERT(GET_MEMBER_OFFSET(TTreeNode, ftext) == 0x88);
...
typedef struct
{
    ...
    int Count;
    int unkown_int;
    TTreeNode* FSelection;
    TTreeNode* FStartMultiSelected;
    TTreeNode* FFirstMultiSelected;
    TTreeNode* FLastMultiSelected;
    ULONG_PTR FKeepCollapsedNodes;
    TTreeNode* CacheNode;
    int CacheIndex;
    PVOID FOwner;
    int FTopLvlCapacity;
...
C_ASSERT(GET_MEMBER_OFFSET(TTreeNodes, Count) == 0x18);
C_ASSERT(GET_MEMBER_OFFSET(TTreeNodes, FSelection) == 0X20);
C_ASSERT(GET_MEMBER_OFFSET(TTreeNodes, CacheNode) == 0x48);
C_ASSERT(GET_MEMBER_OFFSET(TTreeNodes, FOwner) == 0x58);
C_ASSERT(GET_MEMBER_OFFSET(TTreeNodes, Item) == 0x68);
typedef struct
{
    char unkown[0x5D0];
...
C_ASSERT(GET_MEMBER_OFFSET(TCustomTreeView, FRClickNode) == 0x5D0);
C_ASSERT(GET_MEMBER_OFFSET(TCustomTreeView, FSelectedNode) == 0x848);
C_ASSERT(GET_MEMBER_OFFSET(TCustomTreeView, FTopItem) == 0x878);
C_ASSERT(GET_MEMBER_OFFSET(TCustomTreeView, Items) == 0x898);
enum Align
{
    None = 0,
    Top = 1,
